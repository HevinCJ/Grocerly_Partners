...
public abstract class Hilt_Settings extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Settings_GeneratedInjector) this.generatedComponent()).injectSettings(UnsafeCasts.<Settings>unsafeCast(this));
    }
  }
