...
public abstract class Hilt_Splash extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_Splash(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Splash_GeneratedInjector) this.generatedComponent()).injectSplash(UnsafeCasts.<Splash>unsafeCast(this));
    }
  }
