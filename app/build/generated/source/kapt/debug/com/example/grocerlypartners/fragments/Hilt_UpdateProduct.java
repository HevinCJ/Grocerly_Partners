...
public abstract class Hilt_UpdateProduct extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UpdateProduct(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UpdateProduct_GeneratedInjector) this.generatedComponent()).injectUpdateProduct(UnsafeCasts.<UpdateProduct>unsafeCast(this));
    }
  }
