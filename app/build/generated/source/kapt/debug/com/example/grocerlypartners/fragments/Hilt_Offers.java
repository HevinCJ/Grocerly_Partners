...
public abstract class Hilt_Offers extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_Offers(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Offers_GeneratedInjector) this.generatedComponent()).injectOffers(UnsafeCasts.<Offers>unsafeCast(this));
    }
  }
