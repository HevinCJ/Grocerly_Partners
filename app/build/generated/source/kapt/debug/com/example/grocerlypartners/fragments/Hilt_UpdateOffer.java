...
public abstract class Hilt_UpdateOffer extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UpdateOffer(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UpdateOffer_GeneratedInjector) this.generatedComponent()).injectUpdateOffer(UnsafeCasts.<UpdateOffer>unsafeCast(this));
    }
  }
