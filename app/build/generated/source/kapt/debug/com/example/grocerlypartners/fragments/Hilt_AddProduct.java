...
public abstract class Hilt_AddProduct extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddProduct(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddProduct_GeneratedInjector) this.generatedComponent()).injectAddProduct(UnsafeCasts.<AddProduct>unsafeCast(this));
    }
  }
