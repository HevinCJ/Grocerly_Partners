...
public abstract class Hilt_AddOffer extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddOffer(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddOffer_GeneratedInjector) this.generatedComponent()).injectAddOffer(UnsafeCasts.<AddOffer>unsafeCast(this));
    }
  }
