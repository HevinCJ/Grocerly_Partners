...
public abstract class Hilt_Home extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Home_GeneratedInjector) this.generatedComponent()).injectHome(UnsafeCasts.<Home>unsafeCast(this));
    }
  }
