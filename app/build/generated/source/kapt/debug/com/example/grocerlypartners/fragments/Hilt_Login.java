...
public abstract class Hilt_Login extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_Login(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Login_GeneratedInjector) this.generatedComponent()).injectLogin(UnsafeCasts.<Login>unsafeCast(this));
    }
  }
