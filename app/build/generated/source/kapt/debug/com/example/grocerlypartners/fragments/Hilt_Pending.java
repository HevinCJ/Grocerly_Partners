...
public abstract class Hilt_Pending extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_Pending(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Pending_GeneratedInjector) this.generatedComponent()).injectPending(UnsafeCasts.<Pending>unsafeCast(this));
    }
  }
