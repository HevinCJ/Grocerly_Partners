...
public abstract class Hilt_SignUp extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SignUp(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SignUp_GeneratedInjector) this.generatedComponent()).injectSignUp(UnsafeCasts.<SignUp>unsafeCast(this));
    }
  }
