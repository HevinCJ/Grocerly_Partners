...
public data class UpdateProductArgs(
  ...
  public companion object {
    ...
    public fun fromBundle(bundle: Bundle): UpdateProductArgs {
      bundle.setClassLoader(UpdateProductArgs::class.java.classLoader)
      val __product : Product?
      if (bundle.containsKey("product")) {
        if (Parcelable::class.java.isAssignableFrom(Product::class.java) || Serializable::class.java.isAssignableFrom(Product::class.java)) {
      ...
      return UpdateProductArgs(__product)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): UpdateProductArgs {
      val __product : Product?
