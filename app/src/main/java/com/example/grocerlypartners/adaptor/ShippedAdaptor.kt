...
import com.example.grocerlypartners.databinding.ShippedRcLayoutBinding
import com.example.grocerlypartners.model.Order
import java.text.SimpleDateFormat
import java.util.Date
import java.util.Locale

class ShippedAdaptor(
    ...
    override fun onCreateViewHolder(
        ...
        val binding = ShippedRcLayoutBinding.inflate(LayoutInflater.from(parent.context),parent,false)
        return shippedViewHolder(binding)
    }


    inner class shippedViewHolder(private val binding: ShippedRcLayoutBinding): BaseOrderViewHolder(binding.root){

        override fun bind(order: Order) {
           if (order.items.isNotEmpty()){
               binding.apply {
                   materialcardviewcancelled.visibility = View.INVISIBLE
                   materialCardView5.visibility = View.VISIBLE
               ...
               binding.apply {
                   ...
                   materialCardView5.visibility = View.INVISIBLE
